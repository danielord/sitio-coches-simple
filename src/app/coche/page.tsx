    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Coche no encontrado</h1>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700 dark:text-gray-300">{coche.transmision || 'Automática'}</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <span className="font-medium text-gray-900 dark:text-white">{coche.vendedor?.nombre || 'V&R Autos'}</span>
                </div>
                <div className="flex items-center">
